...
class _InfopageState extends State<Infopage> {
  ...
  Future<void> _handleEpisodeDownload(
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Episode $episodeNumber downloaded successfully')),
        );
      }
    } catch (e) {
      if (mounted) {
                                ...
                                Row(
                                  ...
                                  children: [
                                    !isMobile ? Container(
                                      ...
                                      child: TextButton(
                                        onPressed: () => _navigateToPlayer(data),
                                        style: ButtonStyle(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              "Play ${widget.type == ContentType.tv.value 
                                                ? '${storage?.get("season") ?? "S1"}${storage?.get("episode") ?? "E1"}'
                                                : ""
                                              }",
                                              style: const TextStyle(
                                                color: Colors.black,
